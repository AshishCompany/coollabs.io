  ...
  <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
    <div class="text-center">
      ...
      <p class="max-w-xl mt-5 mx-auto text-xl text-gray-200">
        Applications and services built for your online safety
      </p>
    </div>
  </div>
</div>
  ...
  <div class="relative px-4 sm:px-6 lg:px-8">
    <div class="text-lg max-w-prose mx-auto">
      <p class="mt-8 text-xl text-gray-500 leading-8">
        It's frustrating how deeply we are bonded to large companies. We use
        their products everyday. Rarely thinking of what we give them in return.
      </p>
      <p class="mt-8 text-xl text-gray-500 leading-8">
        We allow them to <span class="text-black font-bold">collect & aggregate</span> our personal information & do
        whatever they want with it!
      </p>
      <p class="mt-8 text-xl text-gray-500 leading-8">
        They are selling literally to anybody who pays for it. <br>(<span class="text-black font-bold">+80%</span> of Google's
        & <span class="text-black font-bold">+98%</span> of Facebook's income is from <a class="underline font-bold text-blue-500" href="https://www.visualcapitalist.com/how-tech-giants-make-billions/">targeted ads!</a>)
      </p>
      <p class="mt-8 text-xl text-gray-500 leading-8">
        Even if you keep yourself far away from their products, they are still
        able to collect data of <a class="underline font-bold text-blue-500" href="https://www.visualcapitalist.com/how-google-tracks-you/">you & your online behavior</a> on any site where
        their services are integrated! <br>(<span class="text-black font-bold">+50%</span> of the websites are using <a class="underline font-bold text-blue-500" href="https://w3techs.com/technologies/details/ta-googleanalytics">Google
          Analytics</a>)
      </p>
      <p class="mt-8 text-2xl text-center text-gray-500 leading-8">
        You & your user's <span class="text-black font-bold">should not be</span> the products!
      </p>
    </div>
  </div>
</div>
...
<div class="bg-white">
  <div
    ...
    <h2
      ...
      <span class="block">Follow our journey on
        <a href="https://twitter.com/andrasbacsai">
          <span class="sr-only">Twitter</span>
          <svg
            class="inline-block w-12 h-12 text-blue-500"
            fill="currentColor"
            viewBox="0 0 24 24"
            aria-hidden="true">
            <path
